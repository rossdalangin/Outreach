...
<div class="wrap cc-outreach-wrap">
    ...
    <p>Comprehensive technical and strategic guide to configuring CloseClient Outreach, securing email deliverability, setting up two-way Google Sheets write-back webhooks, utilizing multi-provider AI engines, and executing the Agency Growth Playbook.</p>
    ...
    <div class="cc-card" style="border-left: 4px solid #007cba;">
        ...
        <ul style="line-height:1.8; font-size:14px;">
            <li><strong>Action 1.1 - Choose AI Provider:</strong> Select from <code>OpenAI API</code> (GPT-4o), <code>Anthropic Claude API</code> (Claude 3.5 Sonnet), or <code>Google Gemini API</code> (gemini-3-flash BETA). All API keys are encrypted at rest using AES-256-CBC.</li>
            <li><strong>Action 1.2 - Set Outreach Mode:</strong> Keep mode set to <code>Draft Mode (Manual Review)</code> during initial launch to review all generated drafts in the Outreach Queue before sending.</li>
    ...
    <div class="cc-card" style="border-left: 4px solid #fd7e14;">
        <h2><span class="dashicons dashicons-search"></span> Step 2: Multi-Source Lead Prospecting & Two-Way Google Sheets Setup</h2>
        ...
        <ul style="line-height:1.8; font-size:14px;">
            ...
            <li><strong>Action 2.2 - Lead Management & Deduplication:</strong> Use <a href="<?php echo admin_url('admin.php?page=closeclient-outreach-leads'); ?>">Lead Management</a> to filter, edit, or click <strong>Delete All Duplicates</strong> to clean duplicate email/company records.</li>
            <li><strong>Action 2.3 - Upload Excel Template:</strong> Upload <code>CloseClient_Outreach_Leads_Template.xlsx</code> or <code>.csv</code> to Google Drive and open in Google Sheets.</li>
            <li><strong>Action 2.4 - Apps Script Webhook Code:</strong> Paste this Webhook script into Google Sheets (<em>Extensions > Apps Script</em>), deploy as Web App (Access: <code>Anyone</code>), and copy the URL into Settings:</li>
        </ul>
  ...
  try {
    ...
    <div class="cc-card" style="border-left: 4px solid #6f42c1;">
        ...
        <ul style="line-height:1.8; font-size:14px;">
            ...
            <li><strong>Action 3.3 - Inspect & Edit Draft Modal:</strong> Open the <a href="<?php echo admin_url('admin.php?page=closeclient-outreach-queue'); ?>">Outreach Queue</a> and click <strong>Preview & Edit</strong>. Use the vertical scrollbar to review full copy, select preset body templates, or customize subject lines.</li>
    ...
    <div class="cc-card" style="border-left: 4px solid #28a745;">
        ...
        <ul style="line-height:1.8; font-size:14px;">
            ...
            <li><strong>Action 4.2 - Time Window Restrictions:</strong> Schedule sending between <code>09:00</code> and <code>17:00</code> during weekdays only (toggle weekend sending in Settings if required).</li>
    ...
    <div class="cc-card" style="border-left: 4px solid #ffc107;">
        ...
        <ul style="line-height:1.8; font-size:14px;">
            ...
            <li><strong>Action 5.2 - AI Sentiment & Summary:</strong> AI classifies intent (Interested, Meeting Requested, Not Interested) and updates the lead record and Google Sheet.</li>
